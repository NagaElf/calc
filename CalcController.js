class CalcController{
    ...
    calc(){
        ...
        if(this._operation.length > 3){//Neste caso precisamos pegar apenas o resultado(numero)
                                    // e o último operador
    ...
    getLastItem(isOperator = true){//alterar o valor do parametro para false faz com que procure o 
                                   //último número
        let lastItem;
    ...
    addOperation(value){
        ...
        if (isNaN(this.getLastOperation())){// a variável value é testada aqui dentro
            ...
            if(this.isOperator(value)){
                ...
                //!!!!!!!!!!!!!!!!!console.log('talvez') É aqui dentro que se faz a 
                //conversão do ponto (0, + número)
    ...
    initiButtonsEvents(){
        ...
        //Percorre a buttons (nodelist), cada item da nodelist é um botão (btn)
        buttons.forEach(btn =>{
